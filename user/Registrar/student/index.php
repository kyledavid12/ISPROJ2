      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../enrollment/check.html"><i class="fa fa-circle-o"></i> Check enrollee requirements </a></li>
            <li><a href="../enrollment/create.php"><i class="fa fa-circle-o"></i> Create student record</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="index.html"><i class="fa fa-circle-o"></i>Manage student record</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
